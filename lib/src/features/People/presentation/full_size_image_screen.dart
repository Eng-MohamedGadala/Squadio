...
class FullSizeImageScreen extends StatefulWidget {
  ...
  const FullSizeImageScreen({Key? key, required this.filePath})
      : super(key: key);
...
class _FullSizeImageScreenState extends State<FullSizeImageScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Image Full Size"),
      ),
      body: Builder(
  ...
  Future<Null> _prepare() async {
    ...
    _tasks!.add(_TaskInfo(name: "File name ", link: widget.filePath));

    _items.add(_ItemHolder(name: 'Dawnload information'));
